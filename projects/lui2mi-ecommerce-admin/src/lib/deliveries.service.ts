...
export class DeliveriesService {
  ...
  private deliveriesQuery = new Parse.Query("ECommerceDelivery").include("address").include("receipt").include("user");
  ...
  public async getDelivery(id) {
    try {
      return await new Parse.Query('ECommerceDelivery').include('user').get(id);
    } catch (e) { }
  }
}
